...
const seriesRepositoryProvider = {
  provide: SeriesRepository,
  inject: [DataSource],
  useFactory: (ds: DataSource) => new SeriesRepository(ds),
};
...
@Module({
  ...
  providers: [episodePipelineStepRepositoryProvider, seriesRepositoryProvider, RepositoryProvider, S3HelperService, GenAIHelperService],
  exports: [episodePipelineStepRepositoryProvider, seriesRepositoryProvider, RepositoryProvider, S3HelperService, GenAIHelperService],
})
